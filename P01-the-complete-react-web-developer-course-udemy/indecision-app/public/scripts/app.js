  ...
  _createClass(Visibility, [{
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(VisibilityText, { details: this.state.visible && "Here are some details for you" })
      );
    }
  }]);
...
var VisibilityText = function (_React$Component2) {
  _inherits(VisibilityText, _React$Component2);

  function VisibilityText(props) {
    _classCallCheck(this, VisibilityText);

    return _possibleConstructorReturn(this, (VisibilityText.__proto__ || Object.getPrototypeOf(VisibilityText)).call(this, props));
  }

  _createClass(VisibilityText, [{
    key: "render",
    value: function render() {
      return React.createElement(
        "div",
